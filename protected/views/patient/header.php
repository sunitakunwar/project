<?php if(Yii::app()->user->getState("type")==3): ?>    
...
<ul>
   ...
   <li><a href='<?php echo $this->createUrl('patient/viewProfile'); ?>'><span>View Profile</span></a></li>
   <li><a href='<?php echo $this->createUrl('patient/index'); ?>'><span>Cases</span></a></li>
	</ul>
