...
$caseResponseConent='<h1>CASE - responses by doctor</h1><h3>'.CHtml::link('Add New Response',array('doctor/addCaseResponse','caseId'=>$caseData->cid )).'</h3><table><thead><tr><th width="200"></th><th></th></tr></thead><tbody>
    '.$data.'
        </tbody>
</table>';
...
$caseMedContent='<h1>CASE - medicines</h1><h3>'.CHtml::link('Add New Medication',array('doctor/prescribeCaseMedicine','caseId'=>$caseData->cid )).'</h3><table><thead><tr><th width="200"></th><th></th></tr></thead><tbody>
    '.$datamed.'
        </tbody>
</table>';
